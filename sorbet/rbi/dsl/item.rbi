...
class Item
  ...
  module GeneratedAttributeMethods
    ...
    def done_before_last_save; end

    sig { returns(T.untyped) }
    def done_before_type_cast; end

    sig { returns(T::Boolean) }
    def done_came_from_user?; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def done_change; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def done_change_to_be_saved; end

    sig { returns(T::Boolean) }
    def done_changed?; end

    sig { returns(T.nilable(T::Boolean)) }
    def done_in_database; end

    sig { returns(T.nilable([T::Boolean, T::Boolean])) }
    def done_previous_change; end

    sig { returns(T::Boolean) }
    def done_previously_changed?; end

    sig { returns(T.nilable(T::Boolean)) }
    def done_previously_was; end

    sig { returns(T.nilable(T::Boolean)) }
    def done_was; end

    sig { void }
    def done_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def list_id_previously_changed?; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_done?; end
