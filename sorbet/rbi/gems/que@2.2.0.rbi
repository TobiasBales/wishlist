...
class ActiveJob::QueueAdapters::QueAdapter
  # source://activejob/7.0.4.1/lib/active_job/queue_adapters/que_adapter.rb#20
  def enqueue(job); end

  # source://activejob/7.0.4.1/lib/active_job/queue_adapters/que_adapter.rb#34
  def enqueue_at(job, timestamp); end

  private

  # source://activejob/7.0.4.1/lib/active_job/queue_adapters/que_adapter.rb#49
