...
class Rails::Application < ::Rails::Engine
  # source://railties/7.0.4.1/lib/rails/application.rb#106
  ...
  # source://railties/7.0.4.1/lib/rails/application.rb#99
  def autoloaders; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#511
  def build_middleware_stack; end

  # source://railties/7.0.4.1/lib/rails/application.rb#383
  def config; end

  # source://railties/7.0.4.1/lib/rails/application.rb#387
  def config=(_arg0); end

  # source://railties/7.0.4.1/lib/rails/application.rb#221
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/7.0.4.1/lib/rails/application.rb#303
  def console(&blk); end

  # source://railties/7.0.4.1/lib/rails/application.rb#432
  def credentials; end

  # source://railties/7.0.4.1/lib/rails/application.rb#403
  def credentials=(_arg0); end

  # source://railties/7.0.4.1/lib/rails/application.rb#101
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.0.4.1/lib/rails/application.rb#101
  def default_url_options=(arg); end

  # source://railties/7.0.4.1/lib/rails/application.rb#497
  def eager_load!; end

  # source://railties/7.0.4.1/lib/rails/application.rb#463
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/7.0.4.1/lib/rails/application.rb#250
  def env_config; end

  # source://railties/7.0.4.1/lib/rails/application.rb#99
  def executor; end

  # source://railties/7.0.4.1/lib/rails/application.rb#309
  def generators(&blk); end

  # source://railties/7.0.4.1/lib/rails/application.rb#476
  def helpers_paths; end

  # source://railties/7.0.4.1/lib/rails/application.rb#370
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/7.0.4.1/lib/rails/application.rb#129
  def initialized?; end

  # source://railties/7.0.4.1/lib/rails/application.rb#291
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/7.0.4.1/lib/rails/application.rb#377
  def initializers; end

  # source://railties/7.0.4.1/lib/rails/application.rb#320
  def isolate_namespace(mod); end

  # source://railties/7.0.4.1/lib/rails/application.rb#153
  def key_generator; end

  # source://railties/7.0.4.1/lib/rails/application.rb#179
  def message_verifier(verifier_name); end

  # source://railties/7.0.4.1/lib/rails/application.rb#492
  ...
  # source://railties/7.0.4.1/lib/rails/application.rb#284
  def rake_tasks(&block); end

  # source://railties/7.0.4.1/lib/rails/application.rb#148
  ...
  # source://railties/7.0.4.1/lib/rails/application.rb#346
  def require_environment!; end

  # source://railties/7.0.4.1/lib/rails/application.rb#351
  def routes_reloader; end

  # source://railties/7.0.4.1/lib/rails/application.rb#133
  def run_load_hooks!; end

  # source://railties/7.0.4.1/lib/rails/application.rb#297
  def runner(&blk); end

  # source://railties/7.0.4.1/lib/rails/application.rb#97
  def sandbox; end
  ...
  # source://railties/7.0.4.1/lib/rails/application.rb#415
  def secret_key_base; end

  # source://railties/7.0.4.1/lib/rails/application.rb#389
  def secrets; end

  # source://railties/7.0.4.1/lib/rails/application.rb#403
  def secrets=(_arg0); end

  # source://railties/7.0.4.1/lib/rails/application.rb#315
  def server(&blk); end

  # source://railties/7.0.4.1/lib/rails/application.rb#472
  def to_app; end

  # source://railties/7.0.4.1/lib/rails/application.rb#358
  def watchable_args; end

  protected

  # source://railties/7.0.4.1/lib/rails/application.rb#570
  def default_middleware_stack; end

  # source://railties/7.0.4.1/lib/rails/application.rb#536
  def ordered_railties; end

  # source://railties/7.0.4.1/lib/rails/application.rb#558
  def railties_initializers(current); end

  # source://railties/7.0.4.1/lib/rails/application.rb#525
  def run_console_blocks(app); end

  # source://railties/7.0.4.1/lib/rails/application.rb#515
  def run_generators_blocks(app); end

  # source://railties/7.0.4.1/lib/rails/application.rb#520
  def run_runner_blocks(app); end

  # source://railties/7.0.4.1/lib/rails/application.rb#530
  def run_server_blocks(app); end

  # source://railties/7.0.4.1/lib/rails/application.rb#504
  def run_tasks_blocks(app); end

  # source://railties/7.0.4.1/lib/rails/application.rb#575
  def validate_secret_key_base(secret_key_base); end

  private

  # source://railties/7.0.4.1/lib/rails/application.rb#609
  def build_middleware; end

  # source://railties/7.0.4.1/lib/rails/application.rb#602
  def build_request(env); end

  # source://railties/7.0.4.1/lib/rails/application.rb#613
  def coerce_same_site_protection(protection); end

  # source://railties/7.0.4.1/lib/rails/application.rb#586
  def generate_development_secret; end

  class << self
    # source://railties/7.0.4.1/lib/rails/application.rb#339
    def add_lib_to_load_path!(root); end

    # source://railties/7.0.4.1/lib/rails/application.rb#81
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/7.0.4.1/lib/rails/application.rb#85
    def find_root(from); end

    # source://railties/7.0.4.1/lib/rails/application.rb#70
    def inherited(base); end

    # source://railties/7.0.4.1/lib/rails/application.rb#77
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#28
  def initialize(*_arg0); end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#13
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#415
  def annotations; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#26
  def api_only; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#276
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#361
  def colorize_logging; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#365
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#420
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#330
  def database_configuration; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#283
  def debug_exception_response_format; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#287
  def debug_exception_response_format=(_arg0); end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#437
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#268
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#312
  def load_database_yaml; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#88
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#289
  def paths; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#429
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#384
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#411
  ...
  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#486
  def credentials_available_for_current_env?; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#470
  def default_credentials_content_path; end

  # source://railties/7.0.4.1/lib/rails/application/configuration.rb#478
  def default_credentials_key_path; end
end

# source://railties/7.0.4.1/lib/rails/application.rb#103
Rails::Application::INITIAL_VARIABLES = T.let(T.unsafe(nil), Array)

# source://sprockets-rails//lib/sprockets/railtie.rb#57
class Rails::Engine < ::Rails::Railtie
  # source://railties/7.0.4.1/lib/rails/engine.rb#432
  def initialize; end
  ...
  # source://railties/7.0.4.1/lib/rails/engine.rb#528
  def call(env); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#547
  def config; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#484
  def eager_load!; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#523
  def endpoint; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#430
  def engine_name(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#534
  def env_config; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#494
  def helpers; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#506
  def helpers_paths; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#430
  def isolated?(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#446
  def load_console(app = T.unsafe(nil)); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#470
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#455
  def load_runner(app = T.unsafe(nil)); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#555
  def load_seed; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#479
  def load_server(app = T.unsafe(nil)); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#462
  def load_tasks(app = T.unsafe(nil)); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#429
  def middleware(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#429
  def paths(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#489
  def railties; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#429
  def root(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#540
  def routes(&block); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#654
  def routes?; end

  protected

  # source://railties/7.0.4.1/lib/rails/engine.rb#659
  def run_tasks_blocks(*_arg0); end

  private

  # source://railties/7.0.4.1/lib/rails/engine.rb#691
  def _all_autoload_once_paths; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#695
  def _all_autoload_paths; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#704
  def _all_load_paths(add_autoload_paths_to_load_path); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#723
  def build_middleware; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#715
  def build_request(env); end

  # source://railties/7.0.4.1/lib/rails/engine.rb#687
  def default_middleware_stack; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#671
  def has_migrations?; end

  # source://railties/7.0.4.1/lib/rails/engine.rb#665
  ...
  class << self
    ...
    # source://railties/7.0.4.1/lib/rails/engine.rb#353
    def called_from; end

    # source://railties/7.0.4.1/lib/rails/engine.rb#353
    def called_from=(_arg0); end

    # source://railties/7.0.4.1/lib/rails/engine.rb#358
    def eager_load!(*_arg0, **_arg1, &_arg2); end

    # source://railties/7.0.4.1/lib/rails/engine.rb#378
    def endpoint(endpoint = T.unsafe(nil)); end

    # source://railties/7.0.4.1/lib/rails/railtie.rb#176
    def engine_name(name = T.unsafe(nil)); end

    # source://railties/7.0.4.1/lib/rails/engine.rb#416
    def find(path); end

    # source://railties/7.0.4.1/lib/rails/engine.rb#374
    def find_root(from); end

    # source://railties/7.0.4.1/lib/rails/engine.rb#675
    def find_root_with_flag(flag, root_path, default = T.unsafe(nil)); end

    # source://railties/7.0.4.1/lib/rails/engine.rb#360
    def inherited(base); end

    # source://railties/7.0.4.1/lib/rails/engine.rb#384
    def isolate_namespace(mod); end
