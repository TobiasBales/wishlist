...
class ActiveStorage::AnalyzeJob < ::ActiveStorage::BaseJob
  ...
  class << self
    # source://activejob/7.0.4.1/lib/active_job/queue_name.rb#56
    def queue_name; end
...
class ActiveStorage::Attached::Many < ::ActiveStorage::Attached
  ...
  # source://activesupport/7.0.4.1/lib/active_support/core_ext/module/delegation.rb#302
  ...
  # source://activesupport/7.0.4.1/lib/active_support/core_ext/module/delegation.rb#294
...
class ActiveStorage::Attachment < ::ActiveStorage::Record
  ...
  # source://activerecord/7.0.4.1/lib/active_record/autosave_association.rb#160
  ...
  class << self
    ...
    # source://activerecord/7.0.4.1/lib/active_record/reflection.rb#11
    def _reflections; end

    # source://activemodel/7.0.4.1/lib/active_model/validations.rb#52
    def _validators; end

    # source://activerecord/7.0.4.1/lib/active_record/enum.rb#116
    def defined_enums; end

    # source://activerecord/7.0.4.1/lib/active_record/scoping/named.rb#174
    def with_all_variant_records(*args, **_arg1); end
  end
end

module ActiveStorage::Attachment::GeneratedAssociationMethods
  # source://activerecord/7.0.4.1/lib/active_record/associations/builder/association.rb#103
  def blob; end

  # source://activerecord/7.0.4.1/lib/active_record/associations/builder/association.rb#111
  def blob=(value); end

  # source://activerecord/7.0.4.1/lib/active_record/associations/builder/belongs_to.rb#132
  def blob_changed?; end

  # source://activerecord/7.0.4.1/lib/active_record/associations/builder/belongs_to.rb#136
  def blob_previously_changed?; end

  # source://activerecord/7.0.4.1/lib/active_record/associations/builder/singular_association.rb#28
  def build_blob(*args, &block); end

  # source://activerecord/7.0.4.1/lib/active_record/associations/builder/singular_association.rb#32
  def create_blob(*args, &block); end

  # source://activerecord/7.0.4.1/lib/active_record/associations/builder/singular_association.rb#36
  def create_blob!(*args, &block); end
  ...
  # source://activerecord/7.0.4.1/lib/active_record/associations/builder/singular_association.rb#19
  def reload_blob; end
...
class ActiveStorage::BaseController < ::ActionController::Base
  ...
  class << self
    ...
    # source://actionpack/7.0.4.1/lib/action_controller/metal/etag_with_template_digest.rb#27
...
class ActiveStorage::Current < ::ActiveSupport::CurrentAttributes
  ...
  class << self
    # source://activesupport/7.0.4.1/lib/active_support/current_attributes.rb#118
    def url_options; end
...
class ActiveStorage::FixtureSet
  ...
  # source://activesupport/7.0.4.1/lib/active_support/testing/file_fixtures.rb#20
